...
void DSB20GeV::Loop()
{
  ...
  TH1F *Fiber1Energy = new TH1F("Fiber1Energy", "Fiber1Energy", 200, 0, 30);
  TH1F *Fiber2Energy = new TH1F("Fiber2Energy", "Fiber2Energy", 200, 0, 140);
  TH1F *Fiber3Energy = new TH1F("Fiber3Energy", "Fiber3Energy", 200, 0, 40);
  TH1F *Fiber4Energy = new TH1F("Fiber4Energy", "Fiber4Energy", 200, 0, 100);
  ...
  TFile f("DSB20GeVXProfile.root", "recreate");
