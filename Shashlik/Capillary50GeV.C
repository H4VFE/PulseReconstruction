#define Capillary50GeV_cxx
#include "Capillary50GeV.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <TMath.h>
...
void Capillary50GeV::Loop()
{
  ...
  TH1F *Fiber2Energy = new TH1F("Fiber2Energy", "Fiber2Energy", 200, 0, 200);
  TH1F *Fiber3Energy = new TH1F("Fiber3Energy", "Fiber3Energy", 200, 0, 50);
  TH1F *Fiber4Energy = new TH1F("Fiber4Energy", "Fiber4Energy", 200, 0, 200);
  ...
  TFile f("Capillary50GeVXProfile.root", "recreate");
