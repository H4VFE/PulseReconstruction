...
void DSB50GeV::Loop()
{
  ...
  TH1F *Fiber2Energy = new TH1F("Fiber2Energy", "Fiber2Energy", 200, 0, 250);
  TH1F *Fiber3Energy = new TH1F("Fiber3Energy", "Fiber3Energy", 200, 0, 80);
  TH1F *Fiber4Energy = new TH1F("Fiber4Energy", "Fiber4Energy", 200, 0, 180);
  ...
  TFile f("DSB50GeVXProfile.root", "recreate");
