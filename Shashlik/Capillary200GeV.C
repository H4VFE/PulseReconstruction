#define Capillary200GeV_cxx
#include "Capillary200GeV.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <TMath.h>
...
void Capillary200GeV::Loop()
{
  ...
  TH1F *Fiber1Energy = new TH1F("Fiber1Energy", "Fiber1Energy", 100, 0, 50);
  TH1F *Fiber2Energy = new TH1F("Fiber2Energy", "Fiber2Energy", 100, 0, 200);
  TH1F *Fiber3Energy = new TH1F("Fiber3Energy", "Fiber3Energy", 100, 0, 100);
  TH1F *Fiber4Energy = new TH1F("Fiber4Energy", "Fiber4Energy", 100, 0, 200);
  ...
  TFile f("Capillary200GeVXProfile.root", "recreate");
