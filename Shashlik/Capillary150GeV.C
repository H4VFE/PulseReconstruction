#define Capillary150GeV_cxx
#include "Capillary150GeV.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <TMath.h>
...
void Capillary150GeV::Loop()
{
  ...
  TH1F *Fiber3Energy = new TH1F("Fiber3Energy", "Fiber3Energy", 100, 0, 80);
  ...
  TFile f("Capillary150GeVXProfile.root", "recreate");
