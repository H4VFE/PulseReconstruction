...
void DSB150GeV::Loop()
{
  ...
  TH1F *Fiber2Energy = new TH1F("Fiber2Energy", "Fiber2Energy", 200, 0, 400);
  TH1F *Fiber3Energy = new TH1F("Fiber3Energy", "Fiber3Energy", 200, 0, 120);
  TH1F *Fiber4Energy = new TH1F("Fiber4Energy", "Fiber4Energy", 200, 0, 300);
  ...
  TFile f("DSB150GeVXProfile.root", "recreate");
