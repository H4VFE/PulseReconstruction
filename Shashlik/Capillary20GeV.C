#define Capillary20GeV_cxx
#include "Capillary20GeV.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <TMath.h>
...
void Capillary20GeV::Loop()
{
  ...
  TH1F *Fiber1Energy = new TH1F("Fiber1Energy", "Fiber1Energy", 200, 0, 20);
  TH1F *Fiber2Energy = new TH1F("Fiber2Energy", "Fiber2Energy", 200, 0, 50);
  TH1F *Fiber3Energy = new TH1F("Fiber3Energy", "Fiber3Energy", 200, 0, 20);
  TH1F *Fiber4Energy = new TH1F("Fiber4Energy", "Fiber4Energy", 200, 0, 60);
  ...
  TFile f("Capillary20GeVXProfile.root", "recreate");
